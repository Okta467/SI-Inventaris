    ...
    <div id="layoutSidenav">
      ...
      <div id="layoutSidenav_content">
        ...
        if ($id_pegawai) {
          ...
          $query_pegawai = 
            "SELECT
                a.id AS id_pegawai, a.nip, a.nama_pegawai, a.jk, a.alamat, a.tmp_lahir, a.tgl_lahir, a.foto_profil,
        ...
        $path_foto_profil = $path_foto_profil ?? base_url_return('assets/img/illustrations/profiles/profile-1.png');
        ?>
                  ...
                  <div class="card-body text-center">
                    ...
                    <div class="mt-4 text-start">
                      ...
                      <div class="small mt-1">
                        ...
                        <?= isset($pegawai['tmp_lahir']) ? "{$pegawai['tmp_lahir']}, " : '<small class="text-muted">Tidak ada, </small>' ?>
