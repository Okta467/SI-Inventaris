<?php
    ...
    $is_allowed_hak_akses = in_array($_POST['xhak_akses'], ['supervisor', 'sales', 'admin']); 
     ...
     *   admin          --> harus 'admin'
     *   selain admin   --> harus 'supervisor', 'sales'
    */
    if (
        $hak_akses_saat_ini === 'admin'
        && $hak_akses_yg_diinput !== 'admin'
        || $hak_akses_saat_ini !== 'admin'
        && !in_array($hak_akses_yg_diinput, ['supervisor', 'sales'])
    ) {
        $_SESSION['msg'] = 'Hak akses yang diinput tidak diperbolehkan!';
        echo "<meta http-equiv='refresh' content='0;pengguna.php?go=pengguna'>";
        return;
